...
export async function execute(interaction) {
  ...
  const commands = new EmbedBuilder()
    ...
    .addFields(
      ...
      {
        name: '`/대회`',
        value: 'Riot 공식 한국어 데이터로 조회하며 결과는 채널에 공개됩니다.\n`/대회 일정 리그:VCT 퍼시픽` · 예정 경기\n`/대회 순위` · 최근 대회의 최신 팀 순위표\n`/대회 순위 대회:2026 스테이지 2 단계:정규 리그` · 선택 순위표\n`/대회 결과 리그:전체` · 승리 팀 로고와 최신순 경기·세트별 다시보기',
        inline: false,
      },
      {
        name: '상점 이동',
